...
class Webhook {
    ...
    */
    async custom(name, message, title, color, imageUrl) {
        let payload = {
            "username": name,
            "attachments": [{
                "fields": [{
    ...
    */
    async image(name, message, title, imageUrl) {
        let payload = {
            "username": name,
            "attachments": [{
                "fields": [{
     ...
     */
    async send(messageBuilder) {
        return await this.sendPayload(messageBuilder.data);
    }
}
