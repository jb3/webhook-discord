...
class Webhook {
    ...
    */
    sendPayload(payload, resolveFunction) {
    ...
    */
    ...
    send(messageBuilder) {
      ...
      // JSONify because Javascript doesn't like to compare objects directly apparently
      if (JSON.stringify(messageBuilder.data.attachments) === JSON.stringify([{"fields":[]}])) {
        messageBuilder.data.attachments = [];
      }
